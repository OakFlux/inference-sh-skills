...
def main() -> None:
    ...
    replacements = [
        ("foxit_verified_package", "dabeinong_verified_package"),
        ('STOCK_ID = "688095"', 'STOCK_ID = "002385"'),
        (
            'COMPANY = "福建福昕软件开发股份有限公司"',
            'COMPANY = "北京大北农科技集团股份有限公司"',
        ),
        ('SHORT_NAME = "福昕软件"', 'SHORT_NAME = "大北农"'),
        ("福建福昕软件开发股份有限公司", "北京大北农科技集团股份有限公司"),
        ("福昕软件", "大北农"),
        ('"foxit"', '"dabeinong"'),
        ("688095.SH", "002385.SZ"),
    ...
    compiled = compile(code, "dabeinong_generated_packaging.py", "exec")
